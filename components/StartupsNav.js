...
import EaseInTransition from "./EaseInTransition.js";
...
export default function Nav({navigation}) {
  return (
    ...
    <Disclosure as="nav" className="">
      {({ open }) => (
        <>
          <div className="bg-gray-900 mx-auto mb-1 max-w-7xl px-2 sm:px-6 lg:px-8">
                    ...
                    <div className="max-w-screen-xl mx-auto lg:px-40 px-6">
                      <div className="flex justify-between items-center border-gray-100 py-2 md:space-x-10">
                        <div className="flex justify-start lg:w-0 lg:flex-1">
                          <a href="#">
                            <span className="text-gray-50 text-3xl md:text-4xl font-medium" style={{ fontFamily: "Spinnaker, sans-serif" }}>
                      ...
                      {navigation.map((item) => (
                        <a
                          ...
                          className={classNames(
                            item.current ? 'underline text-gray-50 font-bold' : 'text-gray-50 hover:text-gray-300',
