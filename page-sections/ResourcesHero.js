    ...
    <div>
      ...
      >
        ...
        <EaseInTransition delay={1} duration={1} initialY={50}>
          ...
          >
            Resources<span className="text-blue-500">.</span>
          </div>
          <hr className="my-6 border border-gray-100/60"></hr>
          <div
            className="text-gray-200 text-subtitle-responsive my-6"
            style={{ fontFamily: "Spinnaker, sans-serif" }}
          >
            We help with everything a founder needs<span className="text-blue-500">.</span>
          </div>
        ...
        <motion.div
          ...
          style={{ fontFamily: "Spinnaker, sans-serif" }}
        >
          <div className="text-gray-200 hover:text-gray-500 mb-2">What We Provide</div>
